...
from action.login import login, Kiwoom2
...
def start():
    ...
    if k == 2:
        ...
        if n == 3:
            # 조건식 검색
            from information.condition_list import condition_list
            print("몇번째 조건식?")
        ...
        if n == 4:
            ...
            from information.last_price import last_price
            print("주식번호")
            lp_num = int(input())
    ...
    if k == 4:
        # 잔고 확인
        from information.jango import Kiwoom1
